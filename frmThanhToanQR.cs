...
namespace _174_182_QLCHLAPTOP
{
    public partial class frmThanhToanQR : Form
    {
        ...
        {
            var qrcode = $"2|99|{txtSDT.Text}|{txtTen.Text}|{txtEmail.Text}|0|0{txtSoTien.Text}";
            ...
            Bitmap logo = resizeImage(Properties.Resources.logoMoMo, 32, 32) as Bitmap;
